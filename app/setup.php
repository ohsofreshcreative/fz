 ...
 * Zmiana komunikatu „Brak produktów” w WooCommerce

 */

add_filter('woocommerce_no_products_found', 'ohsofresh_custom_no_products_text');

function ohsofresh_custom_no_products_text() {
    ...
    return '
        ...
        <div class="conference-registration-closed">
            ...
            <p>
                ...
                Rejestracja online jest już zamknięta.

            </p>

            <p>

                W przypadku pytań lub chęci uzyskania dodatkowych informacji 

                prosimy o kontakt z organizatorem konferencji.
